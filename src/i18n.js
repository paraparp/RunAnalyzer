...
const en = {
  translation: {
    ...
    planner: {
      ...
      prompt: "Act as an elite sports physiologist and professional running coach applying validated training science (Banister PMC CTL/ATL/TSB, Seiler 80/20 polarized, Gabbett acute:chronic for injury risk). ATHLETE CONTEXT (scientific data — training load, ACWR, HR zones, reference paces, personal bests, polarized distribution, wearable): {{history}}. GOAL: Run {{dist}} in {{time}} minutes, plan horizon {{weeks}} weeks. Availability: {{daysCount}} days ({{daysStr}}). RULES: 80/20 polarized; keep the weekly load ramp safe (ACWR ~0.8–1.3); size volume to the current CTL; periodize toward the goal for week 1 of {{weeks}}. Use the EXACT reference paces and HR zones from the context — do not invent figures. GENERATE EXACTLY {{daysCount}} SESSIONS.",
      distances: {
        "5k": "5K",
        "10k": "10K",
        "21k": "Half Marathon",
...
const es = {
  translation: {
    ...
    planner: {
      ...
      prompt: "Actúa como un fisiólogo deportivo de élite y entrenador de running profesional que aplica ciencia validada del entrenamiento (modelo PMC de Banister CTL/ATL/TSB, polarizado 80/20 de Seiler, ratio agudo:crónico de Gabbett para riesgo de lesión). CONTEXTO DEL ATLETA (datos científicos — carga de entrenamiento, ACWR, zonas de FC, ritmos de referencia, marcas personales, distribución polarizada, wearable): {{history}}. OBJETIVO: Correr {{dist}} en {{time}} minutos, horizonte del plan {{weeks}} semanas. Disponibilidad: {{daysCount}} días ({{daysStr}}). REGLAS: 80/20 polarizado; mantén segura la rampa de carga semanal (ACWR ~0,8–1,3); dimensiona el volumen al CTL actual; periodiza hacia el objetivo para la semana 1 de {{weeks}}. Usa los ritmos de referencia y zonas de FC EXACTOS del contexto; no inventes cifras. GENERA EXACTAMENTE {{daysCount}} SESIONES.",
      distances: {
        "5k": "5K",
        "10k": "10K",
        "21k": "Media Maratón",
